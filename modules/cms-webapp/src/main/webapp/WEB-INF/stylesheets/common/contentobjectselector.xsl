...
<xsl:stylesheet version="1.0" exclude-result-prefixes="#all"
    ...
    <xsl:template name="contentobjectselector_multi">
        ...
        <td>
            ...
            <input type="hidden" name="{$name}_portletobjdoc" value="{$objdoc}"/>
            <input type="text" readonly="readonly">
                <xsl:attribute name="name">view<xsl:value-of select="$name"/>_portlet</xsl:attribute>
            ...
            <xsl:call-template name="button">
                ...
                <xsl:with-param name="name">btn<xsl:value-of select="$name"/>_portletup</xsl:with-param>
                <xsl:with-param name="onclick">javascript: moveUp('<xsl:value-of select="$name"/>_portlet', this )</xsl:with-param>
            ...
            <xsl:call-template name="button">
                ...
                <xsl:with-param name="name">btn<xsl:value-of select="$name"/>_portletdown</xsl:with-param>
                <xsl:with-param name="onclick">javascript: moveDown('<xsl:value-of select="$name"/>_portlet', this )</xsl:with-param>
            ...
            <xsl:call-template name="button">
                ...
                <xsl:with-param name="name">btn<xsl:value-of select="$name"/>_portletdel</xsl:with-param>
                <xsl:with-param name="onclick">
